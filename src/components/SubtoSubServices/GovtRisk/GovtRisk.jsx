...
const GovtRisk = () => {
  ...
  const subtosubServicesArray = [
    {
      id:1,
      title : 'Support for GRC based firmware for User Management , Security Info       ' ,       
      icon: One,
      color :"#0623D9",
  ...
  {
      id:2,
      title : 'Event Management (LAPR GRC Model)   ',
      icon: Two,
      color :"#00B47E",
