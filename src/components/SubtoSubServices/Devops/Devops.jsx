...
const DevOps = () => {
  ...
  const subtosubServicesArray = [
    {
      id:1,
      title : 'DevOps Initiation Strategy –      ' ,       
      icon: One,
      color :"#0623D9",
  ...
  {
      id:2,
      title : 'Containerization – Total Application Performance Monitoring       ',
      icon: Two,
      color :"#00B47E",
  ...
  {
      id:4,
      title : 'CI/CD tools for Implementation',
      icon: Two,
      color :"#00B47E",
