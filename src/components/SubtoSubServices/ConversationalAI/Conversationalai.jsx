...
const ConversationalAI = () => {
  ...
  {
      id:2,
      title : ', Intent Driven Conversational AI Applications      ',
      icon: Two,
      color :"#00B47E",
  ...
  {
      id:3,
      title : 'Agent & Supervisor Experience for CSAT       ',
      color :"#020C4E",
      icon: One,
