...
const CloudOptimization = () => {
  const title = "Cloud Optimization";
  const pageName = "Cloud Engineering";
  const descTitle = "TITLE";
  const subtitle = "Drive value and speed of business impact";
  const casestudytitle = "Cloud Optimization";
  ...
  const subtosubServicesArray = [
    {
      id:1,
      title : 'Multidimensional Rightsizing of Data under IaaS & containers' ,       
      icon: One,
      color :"#0623D9",
  ...
  {
      id:2,
      title : 'Realtime Scale Decisions (Vertical or Horizontal)      ',
      icon: Two,
      color :"#00B47E",
  ...
  {
      id:3,
      title : 'Right Sizing Models or SKU’s       ',
      color :"#020C4E",
      icon: One,
  ...
  {
      id:4,
      title : 'Automation for work-cycles and work-flows      ',
      icon: Two,
      color :"#00B47E",
  ...
  return (
    <div className='cloudoptimization'>
