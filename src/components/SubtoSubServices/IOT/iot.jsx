...
const IOT = () => {
  ...
  {
      id:3,
      title : '3rd Party Integration to existing application       ',
      color :"#020C4E",
      icon: One,
  ...
  {
      id:5,
      title : 'OTA Services (Update and Management)       ',
      icon: One,
      color :"#0623D9",
