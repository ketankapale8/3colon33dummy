...
const HybridCloud = () => {
  ...
  const subtosubServicesArray = [
    {
      id:1,
      title : 'Create content based on Veritas Website' ,       
      icon: One,
      color :"#0623D9",
