...
const LowCode = () => {
  ...
  const subtosubServicesArray = [
    {
      id:1,
      title : 'Model Application with Drag & Drop Features ' ,       
      icon: One,
      color :"#0623D9",
  ...
  {
      id:2,
      title : 'Simplified Application Composition       ',
      icon: Two,
      color :"#00B47E",
  ...
  {
      id:4,
      title : 'Effortless Deployment and Operations ',
      icon: Two,
      color :"#00B47E",
